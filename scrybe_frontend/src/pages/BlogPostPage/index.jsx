      ...
      >
        ...
        <div className={utils.d_grid} style={{ "--gap": "32px" }}>
          ...
          <ul>
            ...
            <li>
              <a href="#insights">Consumer Insights vs. Market Research</a>
            </li>
            <li>
              <a href="#insights">Consumer Insights: How to Gather Them</a>
            </li>
            <li>
              <a href="#insights">How to Use Consumer Insights</a>
            </li>
          </ul>

          <h2>What are consumer insights?</h2>
          <p>
            Consumer insight is data that a company collects about its customer
            base to learn more about what they need and how they feel about the
          ...
          <h2>Why is it crucial to have consumer insights?</h2>
          ...
          <h2>Consumer Insights vs. Market Research.</h2>
          ...
          <h2>Consumer Insights: How to Gather Them.</h2>
          ...
          <h2>How to Use Consumer Insights.</h2>
